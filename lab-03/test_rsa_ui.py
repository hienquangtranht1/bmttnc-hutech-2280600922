    ...
    def generate_keys(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.show_error(f"Error while calling API: Status code {response.status_code}")
        except requests.exceptions.ConnectionError:
            self.show_error("Connection Error: API server is not running. Please start the API server first.")
